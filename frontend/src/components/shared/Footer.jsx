      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://www.facebook.com/share/1DubwNjDNE/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://x.com/LokeshN3255?t=Act1NcB3vyi7q1l1rtM0RQ&s=09" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400" aria-label="Twitter X">
            ...
            <a href="https://www.linkedin.com/in/venkata-lokesh-babu-neelisetty-06665517a/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400" aria-label="LinkedIn">
